...
public class AllRepairBillActivity extends Activity implements View.OnClickListener {
    ...
    private String id;
    private String url="http://115.28.201.92/smartprotecter/sm/ServiceMessage.php";
    private String urlRepair="http://115.28.201.92/smartprotecter/sm/ServiceAccept.php";
        ...
        han = new Handler(){
            ...
            private void parseJSONWithJSONObject(String Jsmess) {
                ...
                try {
                    ...
                    String memo=temp.getString("remark");
