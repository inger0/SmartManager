...
public class LoginActivity extends Activity {
    ...
    private String url="http://115.28.201.92/smartprotecter/sm/ManagerLogin.php";
    private String urlImagePath="http://115.28.201.92/smartprotecter/sm/ManagerIcon.php";
               ...
               String Jsmess = (String) msg.obj;
                ...
                if(Jsmess.equals("1")){
                    ...
                    try {
                        ...
                        //得到数据
                        String urlImage = temp.getString("icon_m");
        ...
        han = new Handler(){
            ...
            private void getMessage(String Jsmess) {
                ...
                try {
                    ...
                    imagePath=temp.getString("icon_m");
